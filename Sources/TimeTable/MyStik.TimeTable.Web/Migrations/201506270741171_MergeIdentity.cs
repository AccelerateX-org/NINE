namespace MyStik.TimeTable.Web.Migrations
{
    ...
    public partial class MergeIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.AspNetUsers", "LikeEMails", c => c.Boolean(nullable: false));
            AlterColumn("dbo.AspNetUsers", "MemberState", c => c.Int(nullable: false));
        ...
        public override void Down()
        {
            ...
            DropPrimaryKey("dbo.AspNetUserLogins");
            AlterColumn("dbo.AspNetUsers", "MemberState", c => c.Int());
            AlterColumn("dbo.AspNetUsers", "LikeEMails", c => c.Boolean());
