...
namespace MyStik.TimeTable.Data.DefaultData
{
    ...
    {
        public void InitCatalogar_GS(ActivityOrganiser fk01, Curriculum ar)
        {
...
/*
    ...
    public void InitCatalogar_Studienrichtungen(ActivityOrganiser fk01, Curriculum ar)
        {

            //Vertiefung Architektur

            var entwurf5arc = new CurriculumModule()
            {
                ShortName = "EW5",
                Name = "Entwurf 5",
                ModuleId = "BA21AD",
            ...
            entwurf5arc.Groups.Add(GetGroup(ar, "5 ARC"));

            ar.Modules.Add(entwurf5arc);

            _db.CurriculumModules.Add(entwurf5arc);


            var entwurf5kon = new CurriculumModule()
            {
                ShortName = "EW5",
                Name = "Entwurf 5",
                ModuleId = "BA21BD",
            ...
            entwurf5kon.Groups.Add(GetGroup(ar, "5 KON"));

            ar.Modules.Add(entwurf5kon);

            _db.CurriculumModules.Add(entwurf5kon);

            var entwurf5stb = new CurriculumModule()
            {
                ShortName = "EW5",
                Name = "Entwurf 5",
                ModuleId = "BA21UD",
            ...
            entwurf5stb.Groups.Add(GetGroup(ar, "5 STB"));

            ar.Modules.Add(entwurf5stb);

            _db.CurriculumModules.Add(entwurf5stb);
